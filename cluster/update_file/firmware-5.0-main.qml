...
ApplicationWindow {
    ...
    Text {
        ...
        text: "speed limit under 200km/h"
        anchors.horizontalCenterOffset: speedImage.horizontalCenterOffset
    ...
    Canvas {
        ...
        onPaint: {
            ...
            // Draw the speed bar
            var angle = (speedReceiver.speedValue - 35) * Math.PI / 180 *200 / 260; // Convert speed to angle
            ctx.beginPath();
        ...
        Connections {
            ...
            onButtonsValueChanged: {
                ...
                if (buttonValue === "P" || buttonValue === "R" || buttonValue === "N" || buttonValue === "D") {
                    ...
                    weatherAPI.requestWeather(city);
                }
